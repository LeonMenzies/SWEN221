...
public class Move implements Operation {
	 ...
	 * @param l1
	 * @param l2
	 * @return - True if it is next to or false if not
	 */
	public static boolean nextTo(Location l1, Location l2) {
		// two locations will only next to each other if the outcome is 1
		return Math.abs(l2.row - l1.row) + Math.abs(l2.col - l1.col) == 1;
	}
}
