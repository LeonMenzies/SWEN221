...
public interface CardGame extends Cloneable {
	...
	/**
	 * Return the winner(s) of this game. Note that there can be multiple winners in
	 * games where players form partnerships, or where there is a draw.
	 * 
	 * @return
	 */
	...
	/**
	 * Signal that the current hand is over. This is a useful opportunity to update
	 * player scores, etc.
	 */
	public void endHand();

	/**
	 * Signal that the current round is over. This is a useful opportunity to update
	 * player trick counts, etc.
	 */
