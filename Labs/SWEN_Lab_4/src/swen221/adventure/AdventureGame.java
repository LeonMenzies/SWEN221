...
import swen221.adventure.model.Book;
import swen221.adventure.model.Coin;
import swen221.adventure.model.Door;
import swen221.adventure.model.Item;
import swen221.adventure.model.Key;
import swen221.adventure.model.LockedDoor;
import swen221.adventure.model.Obelisk;
import swen221.adventure.model.Player;
import swen221.adventure.model.Room;
import swen221.adventure.model.SecretButton;
...
public class AdventureGame {
	...
	/**
	 * Construct an adventure game from a list of GameFile items. This constructor
	 * creates the game world according to this list. If the list contains an item
	 * which is not recognised then an exception will be thrown.
	 * 
	 * @param items
	 */
	...
	/**
	 * Convert a GameFile.Item into a real game world object. This reads the fields
	 * of the given GameFile.Item object and then constructs a new object to
	 * represent it in the game.
	 * 
	 * @param item
	 * @return
	 */
	...
	/**
	 * Create a LockedDoor within the game. A door connects two rooms within the
	 * game.
	 * 
	 * @param item
	 * @return
	...
	/**
	 * Create a Secret Button within the game.
	 * 
	 * @param item
	 * @return
	 */
	private Item createSecretButton(GameFile.Item item) {
		int code = (Integer) item.field("code");
		SecretButton s = new SecretButton(code);
		return addItemToRoom((Integer) item.field("location"), s);
	}
	...
	public static void main(String[] args) {
		...
		String[] items = { "Room { description: \"The Great Hall\"}", "Room { description: \"The Dining Room\"}",
				"Door { from: 0, to: 1 }", "Coin { location: 0 }", "Obelisk { location: 0 }",
