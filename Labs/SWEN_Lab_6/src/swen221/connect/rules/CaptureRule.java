...
public class CaptureRule implements Rule {
	 ...
	 *
	 * @param current  --- The current game board which we are updating.
	 * @param original --- The original state of the game board, before we removed
	...
	/**
	 * Check whether a given piece is captured or not. There are essentially four
	 * different cases to check: short and long vertical, and short and long
	 * horizontal.
	 *
	 *
	 * @param original --- The board that we are checking against.
	...
	/**
	 * Return the opposite player's token kind. This is needed to determine for a
	 * given token on the board, what colour the pieces are which could capture it.
	 *
	 * @param token
	 * @return
	 */
